...
public class OrderDAO extends AbstractDAO<Order> implements IOrderDAO {
    ...
    public void update(UUID id, Order item) throws DAOException {
        ...
        try {
            ...
            LOGGER.log(Level.WARN, String.format("UPDATE_ERROR", id));
    ...
    public void delete(UUID id) throws DAOException {
        ...
        try {
            ...
            LOGGER.log(Level.WARN, String.format("DELETE_ORDER_ERROR", id));
    ...
    public Order getEntityById(UUID id) throws DAOException {
        ...
        try {
            ...
            LOGGER.log(Level.WARN, String.format("GET_ENTITY_BY_ID_ERROR", id));
